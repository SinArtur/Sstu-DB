...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for institute_data in institutes_data:
            ...
            # Create departments as directions (since DEPARTMENT type doesn't exist, use DIRECTION)
        ...
        self.stdout.write(self.style.SUCCESS(
            f'Всего кафедр (направлений): {Branch.objects.filter(type=Branch.BranchType.DIRECTION, status=Branch.Status.APPROVED).count()}'
        ))
