...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Quick Start Guide */}
      <div className="bg-card border rounded-lg p-4 md:p-6 mb-4 md:mb-6">
        <h2 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Быстрый старт</h2>
        <ol className="space-y-2 md:space-y-3 list-decimal list-inside text-sm md:text-base">
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-4 md:mb-6">
        <Link
          to="/branches"
          className="p-4 md:p-6 bg-card border rounded-lg hover:border-primary transition-colors"
        >
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2">Перейти в базу знаний</h3>
              <p className="text-xs md:text-sm text-muted-foreground">
                Просмотр и поиск материалов
              </p>
            </div>
            <BookOpen className="h-6 w-6 md:h-8 md:w-8 text-primary flex-shrink-0 ml-2" />
          </div>
        </Link>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2">Мои загрузки</h3>
              <p className="text-xs md:text-sm text-muted-foreground">
                {stats?.myMaterials || 0} материалов
              </p>
            </div>
            <Upload className="h-6 w-6 md:h-8 md:w-8 text-primary flex-shrink-0 ml-2" />
          </div>
        </Link>
      </div>
      ...
      {stats && (
        <div className="bg-card border rounded-lg p-4 md:p-6">
          <h2 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Статистика</h2>
